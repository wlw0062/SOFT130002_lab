...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              $countryNum = array("DE","GR","IT","CA","GB","US");
              for ($num=0;$num<6;$num++){
                  $str = $countries[$countryNum[$num]];
                  echo "<a href='list.php?country=$str' role='button' class='btn btn-default'> $str</a>";
              }
              ?>
...
//                 </a>
//			</li>
         $imgNum = array(22,54,7,19,46,6,60,58,75,77,27,2,24,13,101,102);
          for ($num=0;$num<16;$num++){
              $id = $images[$imgNum[$num]]["id"];
              $src = $images[$imgNum[$num]]["path"];
              $alt = $images[$imgNum[$num]]["title"];
              echo "<li>
                    <a href='detail.php?id=$id' class='img-responsive'>
                    <img src='images/square/$src' alt=$alt>
                    <div class='caption'>
                    <div class='blur'></div>
                    <div class='caption-text'>
                    <h1>$alt</h1>
